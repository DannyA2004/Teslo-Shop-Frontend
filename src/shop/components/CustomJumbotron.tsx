...
export const CustomJumbotron = ({title, subtitle}: Props) => {
  ...
  const defaultSubtittle = "Minimalist and stylish clothing inspired by Tesla's futuristic design. Premium quality for timeless style"
